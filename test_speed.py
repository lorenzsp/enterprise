# This script is basically a copy of one of the tests in the code. I think it can be useful to understand what we compute to get the likelihood
...
# function for testing the likelihood
...
# uitlity function for importing data
...
# pulsar object for importing data
Psrs = [
...
# likelihood computation test. This function breaksdown each step of the likelihood computation and checks if it corresponds to the one implemented. I have added also the timing which is very fast for this simplified case
def compute_like(npsrs=1, inc_corr=False, inc_kernel=False, cholesky_sparse=True, marginalizing_tm=False):
    ...
    psrs = Psrs if npsrs == 2 else [Psrs[0]]
    ...
    for mth in method:
        ...
        print("likelihood evaluation took: ",toc-tic, " seconds, with method", mth)
...
# test likelihood is correct
test_like_corr()

print("you might say, well this is fast... now try running test_real_speed.py")